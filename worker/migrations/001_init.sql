...
CREATE INDEX IF NOT EXISTS idx_market_snapshots_symbol_created_at ON market_snapshots (symbol, created_at);
CREATE INDEX IF NOT EXISTS idx_surge_events_triggered_at ON surge_events (triggered_at);
