...
for (const [token, message] of [
  ...
  ['CREDENTIAL_LEASE_UNUSED', 'credential lease must fail if its callback is skipped'],
  ...
  ["stub.fetch(new Request('https://bitget-demo-rate.internal/claim'", 'rate claims must use an explicit Request to the account-scoped Durable Object stub'],
